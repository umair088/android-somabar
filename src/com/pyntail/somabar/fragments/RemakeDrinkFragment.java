...
public class RemakeDrinkFragment extends BaseSupportFragment {
	...
	@InjectView(R.id.progressOfDrink)
	public ProgressBar progressOfDrink;
	
	

	public static RemakeDrinkFragment newInstance() {
		return new RemakeDrinkFragment();
	}
	...
	public View onCreateView(LayoutInflater inflater,
		...
		if (parentView == null) {
			parentView = inflater.inflate(R.layout.fragment_remake,
					container, false);
	...
	public void setTitleBar(TitleBar titleBar) {
		...
		titleBar.setRightTextOption("Save");
		titleBar.setOnRightTextClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				UIHelper.showLongToastInCenter(v.getContext(), "Saved");
			}
		});
		...
		titleBar.setHeadingText("Edit a Drink");
	...
	private void setListener() {
		btnAdd.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				activtyReference.addDockableSupportFragmentWithAnim(AddIngredientsFragment.newInstance(true), AddIngredientsFragment.class.getSimpleName());
			}
		});
