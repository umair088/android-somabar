...
public class EditDrinkFragment extends BaseSupportFragment {
	...
	public AnyTextView btnSave;

	public static EditDrinkFragment newInstance() {
		return new EditDrinkFragment();
	}
	...
	public View onCreateView(LayoutInflater inflater,
		...
		if (parentView == null) {
			parentView = inflater.inflate(R.layout.fragment_edit_a_drink,
					container, false);
	...
	private void setListener() {
		 ...
		 * (AddIngredientsFragment.newInstance(),
		 * AddIngredientsFragment.class.getSimpleName()); } });
		 */
