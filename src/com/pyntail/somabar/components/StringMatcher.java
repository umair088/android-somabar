...
package com.pyntail.somabar.components;

public class StringMatcher {
	
	private final static char KOREAN_UNICODE_START = 'd';
	private final static char KOREAN_UNICODE_END = 'd';
	private final static char KOREAN_UNIT = 'd';
	private final static char[] KOREAN_INITIAL = {'d', 'd','d', 'd'};
