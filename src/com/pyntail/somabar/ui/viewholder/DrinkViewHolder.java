...
public class DrinkViewHolder extends AbsViewHolder<MyDrinkItem> {
	...
	protected void updateView(final Context context, final MyDrinkItem object) {
		...
		final ImageButton imgFav = (ImageButton) findViewByIdEfficient(R.id.imgFav);
		if(object.isFavorite())
			imgFav.setBackgroundResource(R.drawable.star_orange);
		else
			imgFav.setBackgroundResource(R.drawable.star_icon);
		
		
		final RelativeLayout favContainer = (RelativeLayout) findViewByIdEfficient(R.id.favContainer);
		favContainer.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				WebServiceFactory.getInstance().markFavourite(
						object.getReciepeId(), encodedToken,
						new CallbackRetrofit<FavoriteObject>() {
							...
							@Override
							public void on204(FavoriteObject value,
									Response response) {
								hostActivity.hideSweetLoader();
							...
							@Override
							public void on200(FavoriteObject value,
									Response response) {
								hostActivity.hideSweetLoader();
