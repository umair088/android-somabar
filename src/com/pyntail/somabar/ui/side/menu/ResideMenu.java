...
public class ResideMenu extends FrameLayout {
	...
	private LinearLayout configureAccountContainer;

	public float mScaleXValue = 0.8f;
	public float mScaleYValue = 0.9f;

	// public float mTranslateValue = 2.2f;
	
	
	@InjectView(R.id.txtUserTitle)
	@Nullable
	...
	private void initViews(Context context) {
		...
		configureAccountContainer = (LinearLayout) findViewById(R.id.configureAccountContainer);
	...
	public void setOnUserImageClickListener(OnClickListener listener) {
		imgUser.setOnClickListener(listener);

	}
	
	public void setOnConfigureUserContainer(OnClickListener listener) {
		configureAccountContainer.setOnClickListener(listener);

	}
	
	public void setOnUserTitleClickListener(OnClickListener listener) {
		txtUserTitle.setOnClickListener(listener);

	}
	
	public void setOnUserFacebookClickListener(OnClickListener listener) {
		btnFacebook.setOnClickListener(listener);

	}
	
	public void setOnUserSignInClickListener(OnClickListener listener) {
		btnSignin.setOnClickListener(listener);

	}
	
	public void setOnUserSignUnClickListener(OnClickListener listener) {
		btnSignup.setOnClickListener(listener);

	}
	
	public void setOnUserNameClickListener(OnClickListener listener) {
		txtUserName.setOnClickListener(listener);

	}
	
	
	public void hideConfigureUserContainer() {
		configureAccountContainer.setVisibility(View.INVISIBLE);
	}
	
	public void showConfigureUserContainer() {
		configureAccountContainer.setVisibility(View.VISIBLE);
	}
	...
	public void openMenu(int direction) {
		...
		// setScale(mTranslateValue);

		isOpened = true;
		AnimatorSet scaleDown_activity = buildScaleDownAnimation(viewActivity,
				mScaleXValue, mScaleYValue);
		AnimatorSet scaleDown_shadow = buildScaleDownAnimation(imageViewShadow,
				mScaleXValue + shadowAdjustScaleX, mScaleXValue
						+ shadowAdjustScaleY);
	...
	private void setScaleDirection(int direction) {
		...
		float pivotX;
		float pivotY = getScreenHeight() * 0.7f;
	...
	private void setScale(float pivotX_multiplier) {
		...
		scrollViewMenu = scrollViewRightMenu;
		pivotX = screenWidth * -pivotX_multiplier;
